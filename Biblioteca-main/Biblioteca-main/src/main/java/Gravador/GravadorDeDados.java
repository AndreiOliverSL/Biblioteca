...
public class GravadorDeDados{
    ...
    public static class GravadorDeDadosLivros {

        public static final String ARQUIVO_LIVROS = " C:\\Users\\Raphael\\Documents\\ProjetoAyla2023.1.POO";
        ...
        public void salvarLivro(Map<String, Livro> livros) throws IOException {
            ...
            try {
                ...
                e.printStackTrace();
                throw new IOException("Erro ao salvar os livros no arquivo " + ARQUIVO_LIVROS);
            }
        }
    }
}
